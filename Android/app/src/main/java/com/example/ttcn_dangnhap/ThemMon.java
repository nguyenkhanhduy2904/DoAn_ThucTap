...
public class ThemMon extends AppCompatActivity {
    ...
    LinearLayout btn_upload_image, layout_nbd, layout_nkt,layout_percent;
    ImageView img;
    EditText etxtFoodName, etxtFoodDesc, etxtPrice;
    RadioGroup rbgQuocGia,rgDiscount;
    RadioButton rbVN, rbTL, rbHQ, rbTQ, rdo_on, rdo_off,rb_con,rb_het;
    ...
    void addControls(){
        ...
        rdo_on = findViewById(R.id.rdo_on);
        rdo_off = findViewById(R.id.rdo_off);
        rb_con=findViewById(R.id.rb_con);
        rb_het=findViewById(R.id.rb_het);
